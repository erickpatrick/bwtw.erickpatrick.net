...
export const meta = {
  ...
  description:
    'After long time without posts, I decided for a new year resolution: new layout and weekly posts...',
...
> **A note about GTmetrix**: This tool goes to both PageSpeed and YSlow.

Only two things I need to make everything a perfect 100 score: Add a _expires header_ to the small JavaScript file the site uses; and find a way to minify even my HTML and JavaScript (to save 0.5kb according to PageSpeed). For me, it's not a huge save at the moment, but imagine that I start getting thousands/millions of views per month. This would save my pocket a few dozen dollars =)
