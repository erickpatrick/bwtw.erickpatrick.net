  ...
  - name: 'posts'
    ...
    fields:
      ...
      - {
          ...
          widget: 'boolean',
          default: false,
          hint: 'Should it be featured on the home page?',
        }
      - {
          name: 'extends',
          widget: 'hidden',
...
![NetlifyCMS Login Page](https://res.cloudinary.com/erickpatrick/image/upload/c_pad,h_400,w_auto,q_60/v1548017008/erickpatrick.net/augmenting-tightenco-jigsaw-with-netlifycms--001 'NetlifyCMS Login Page')

![NetlifyCMS Contents Page](https://res.cloudinary.com/erickpatrick/image/upload/c_pad,h_400,w_auto,q_60/v1548017008/erickpatrick.net/augmenting-tightenco-jigsaw-with-netlifycms--002 'NetlifyCMS Contents Page')

![NetlifyCMS Content Workflow Page](https://res.cloudinary.com/erickpatrick/image/upload/c_pad,h_400,w_auto,q_60/v1548017008/erickpatrick.net/augmenting-tightenco-jigsaw-with-netlifycms--003 'NetlifyCMS Content Workflow Page')

![NetlifyCMS Media Upload Modal](https://res.cloudinary.com/erickpatrick/image/upload/c_pad,h_400,w_auto,q_60/v1548017008/erickpatrick.net/augmenting-tightenco-jigsaw-with-netlifycms--004 'NetlifyCMS Media Upload Modal')

![NetlifyCMS Collection Item Creation/Editing Page](https://res.cloudinary.com/erickpatrick/image/upload/c_pad,h_400,w_auto,q_60/v1548017008/erickpatrick.net/augmenting-tightenco-jigsaw-with-netlifycms--005 'NetlifyCMS Collection Item Creation/Editing Page')
